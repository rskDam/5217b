...
Funktionen af $f_i$ kan skrives som $f_i(a,b)=(a+bs_i - d_i)^2$, hvorved $\frac{\partial}{\partial a}f_i = 2(a + b s_i - d_i)$ og $\frac{\partial}{\partial b}f_i = 2(a + b s_i - d_i)s_i$. De to funktioner skrives ind som kode
```{r}
part.a <- function(a,b) 2(a + b* cars$speed - cars$dist)

part.b <- function(a,b) 2(a + b* cars$speed - cars$dist)*cars$speed
