...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Ide: Hvis $\frac{\partial y}{\partial x_1}, $Start med $x_1 ,\ldots , x_n$, $\frac{\partial x_1}{\partial x_1}=1$ og $\frac{\partial x_2}{\partial x_1}, \ldots  \frac{\partial x_n}{\partial x_1}$.
    \item Evaluerer funktion indefra.
  \end{itemize}
  \item Reverse: 
  \begin{itemize}
